...
<center><h2>UPDATE QUESTIONS</h2></center>
<main>
...
<p>
<label>Questions - <?php echo $nom_soalan; ?></label>
<input type="text" name="idsoalan" value="<?php
echo $soalan_terpilih; ?>" readonly hidden>
</p>
<p>
...
<br><small style="color:red">*If Required</small></label>
...
WHERE q.idsoalan=$soalan_terpilih");
