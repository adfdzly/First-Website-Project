...
<td><a href="hapus_pelajar.php?UserId=<?php echo $info1['UserId'];?>" onclick="return
confirm('AWAS!, Semua rekod yang berkaitan akan dihapuskan, Anda Pasti?')"><button>Delete</button></a></td>
								</tr>
                                <?php $no++; } ?>
